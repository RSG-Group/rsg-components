...
var RSGButton = React.createClass({
  displayName: 'RSGButton',
  ...
  render: function render() {
    ...
    return React.DOM.button(Object.assign({style: RSGStyle}, _.omit(this.props, ['style'])), this.props.children);
  }
});

exports['RSGButton'] = RSGButton;
module.exports = exports['RSGButton'];